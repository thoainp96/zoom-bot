...
namespace ZOOM_SDK_DOTNET_WRAP {
	...
	SDKError CMeetingAudioControllerDotNetWrap::EnableMuteOnEntry(bool bEnable, bool allowUnmuteBySelf)
	{
		return (SDKError)ZOOM_SDK_NAMESPACE::CSDKWrap::GetInst().GetMeetingServiceWrap().
			GetMeetingAudioController().EnableMuteOnEntry(bEnable, allowUnmuteBySelf);
	}
