...
namespace ZOOM_SDK_DOTNET_WRAP {
	...
	{
		return WChar2PlatformString(ZOOM_SDK_NAMESPACE::CSDKWrap::GetInst().GetAuthServiceWrap().getWebinalLegalNoticesPrompt());
	}
	...
	bool CAuthServiceDotNetWrap::getAnnotationLegalNoticesExplained(WebinarLegalNoticesExplainedInfo^% info_)
	{
		...
		bool bRet = ZOOM_SDK_NAMESPACE::CSDKWrap::GetInst().GetAuthServiceWrap().getWebinalLegalNoticesExplained(notice_info);
		if (bRet)
		{
