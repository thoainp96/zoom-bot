...
namespace ZOOM_SDK_DOTNET_WRAP {
	...
	public:
		...
		String^				customer_key;///<The customer key that need the app intergrated with sdk to specify. The SDK will set this value when the associated settings are turned on.
	...
	public:
		...
		IMeetingAANControllerDotNetWrap^ GetMeetingAANController();
	...
	public:
		...
		virtual IMeetingAANControllerDotNetWrap^ GetMeetingAANController();
