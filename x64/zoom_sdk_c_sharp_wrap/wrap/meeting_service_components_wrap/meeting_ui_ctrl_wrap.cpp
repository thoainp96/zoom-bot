...
IMPL_FUNC_1(IMeetingUIController, SetMeetingTopic, SDKError, const wchar_t*, meetingtopic, SDKERR_UNINITIALIZE)
//virtual SDKError SetCustomizedCloudRecordingMgrUrl(const wchar_t* crmURL) = 0;
IMPL_FUNC_1(IMeetingUIController, SetCustomizedCloudRecordingMgrUrl, SDKError, const wchar_t*, crmURL, SDKERR_UNINITIALIZE)
//virtual SDKError SetCustomizedInvitationDomain(const wchar_t* invitation_domain) = 0;
IMPL_FUNC_1(IMeetingUIController, SetCustomizedInvitationDomain, SDKError, const wchar_t*, invitation_domain, SDKERR_UNINITIALIZE)
//virtual SDKError SetCustomizedPollingUrl(const wchar_t* pollingURL, bool bCreate) = 0;
IMPL_FUNC_2(IMeetingUIController, SetCustomizedPollingUrl, SDKError, const wchar_t*, pollingURL, bool, bCreate, SDKERR_UNINITIALIZE)
