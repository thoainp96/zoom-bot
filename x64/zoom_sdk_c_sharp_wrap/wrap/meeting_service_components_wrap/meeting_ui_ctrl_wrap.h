...
DEFINE_FUNC_1(SetMeetingTopic, SDKError, const wchar_t*, meetingtopic)
//virtual SDKError SetCustomizedCloudRecordingMgrUrl(const wchar_t* crmURL) = 0;
DEFINE_FUNC_1(SetCustomizedCloudRecordingMgrUrl, SDKError, const wchar_t*, crmURL)
//virtual SDKError SetCustomizedInvitationDomain(const wchar_t* invitation_domain) = 0;
DEFINE_FUNC_1(SetCustomizedInvitationDomain, SDKError, const wchar_t*, invitation_domain)
//virtual SDKError SetCustomizedPollingUrl(const wchar_t* pollingURL, bool bCreate) = 0;
DEFINE_FUNC_2(SetCustomizedPollingUrl, SDKError, const wchar_t*, pollingURL, bool, bCreate)
