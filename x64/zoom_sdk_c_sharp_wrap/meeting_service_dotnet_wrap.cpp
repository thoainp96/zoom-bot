...
namespace ZOOM_SDK_DOTNET_WRAP {
	...
	SDKError CMeetingServiceDotNetWrap::Join(JoinParam joinParam)
	{
		...
		case SDKUserType::SDK_UT_NORMALUSER:
		{
			...
			joinParam_c.param.normaluserJoin.customer_key = PlatformString2WChar(joinParam.normaluserJoin->customer_key);
		...
		case SDKUserType::SDK_UT_WITHOUT_LOGIN:
		{
			...
			joinParam_c.param.withoutloginuserJoin.customer_key = PlatformString2WChar(joinParam.withoutloginJoin->customer_key);
	...
	SDKError CMeetingServiceDotNetWrap::Start(StartParam startParam)
	{
		...
		case SDKUserType::SDK_UT_NORMALUSER:
		{
			...
			startParam_c.param.normaluserStart.customer_key = PlatformString2WChar(startParam.normaluserStart->customer_key);
		...
		case SDKUserType::SDK_UT_WITHOUT_LOGIN:
		{
			...
			startParam_c.param.withoutloginStart.customer_key = PlatformString2WChar(startParam.withoutloginStart->customer_key);
	...
	IMeetingAANControllerDotNetWrap^ CMeetingServiceDotNetWrap::GetMeetingAANController()
	{
		return CMeetingAANControllerDotNetWrap::Instance;
	}
}